...
class TransactionDaoFake: TransactionDao() {
    ...
    override suspend fun updateTrnTagsSyncByTrnId(
        trnId: String,
        sync: SyncState
    ) {
    ...
    override suspend fun updateMetadataSyncByTrnId(
        trnId: String,
        sync: SyncState
    ) {
        val metadata = metadatas.find { it.id == trnId } ?: return
    ...
    override suspend fun updateTrnEntitySyncById(
        trnId: String,
        sync: SyncState
    ) {
        val transaction = transactions.find {
